...
export default function AuthToggleCapsule({
  ...
  return (
    <div className="absolute top-[30px] left-1/2 -translate-x-1/2 bg-white py-1.5 px-1.5 rounded-[50px] shadow-[0_4px_20px_rgba(0,0,0,0.08)] z-[200] flex gap-1.5 w-[260px] h-[54px] md:w-[260px] md:top-[30px] max-md:w-[220px] max-md:top-5">
      <div
