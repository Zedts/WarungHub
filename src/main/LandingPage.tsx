...
export default function LandingPage() {
  return (
    <>
      <div
        className="absolute top-0 w-full h-screen -z-10 saturate-200 invert-0 blur-lg bg-cover bg-center opacity-30"
        style={{
          backgroundImage:
      ...
      <section className="overflow-hidden pt-32 pb-20 relative">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="max-w-2xl">
            <div className="inline-flex gap-2 text-xs font-semibold text-[#4A7043] bg-gradient-to-r from-[#4A7043]/5 to-[#5A7B9A]/5 border-[#4A7043]/10 border rounded-full mb-8 pt-1.5 pr-4 pb-1.5 pl-4 gap-x-2 gap-y-2 items-center">
          ...
          <div className="relative h-[500px] w-full hidden lg:block">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[95%] h-[85%] backdrop-blur-xl rounded-2xl shadow-2xl border p-8 z-10 bg-white/80 shadow-gray-200/50 border-white/50">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-4 p-3 rounded-xl transition-colors cursor-pointer group hover:bg-gray-50">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center group-hover:bg-white group-hover:shadow-sm bg-gray-100 text-gray-400">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-400">Export Quality</div>
                  </div>
                  <div className="text-sm font-bold text-gray-800">$12,400</div>
                </div>
                <div className="flex items-center gap-4 p-3 rounded-xl transition-colors cursor-pointer group hover:bg-gray-50">
                  <div className="w-10 h-10 rounded-lg flex items-center justify-center group-hover:bg-white group-hover:shadow-sm bg-gray-100 text-gray-400">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-400">Limited Edition</div>
                  </div>
                  <div className="text-sm font-bold text-gray-800">$8,250</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="benefits" className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="p-8 rounded-2xl border shadow-sm hover:shadow-xl hover:shadow-[#4A7043]/5 transition-all duration-300 group bg-white border-gray-100">
              <div className="w-14 h-14 rounded-2xl border text-[#4A7043] flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300 bg-white border-gray-100 shadow-gray-100">
            ...
            <div className="p-8 rounded-2xl border shadow-sm hover:shadow-xl hover:shadow-[#4A7043]/5 transition-all duration-300 group bg-white border-gray-100">
              <div className="w-14 h-14 rounded-2xl border text-[#5A7B9A] flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform duration-300 bg-white border-gray-100 shadow-gray-100">
            ...
            <div className="p-8 rounded-2xl border shadow-sm hover:shadow-xl hover:shadow-[#4A7043]/5 transition-all duration-300 group bg-white border-gray-100">
              <div className="flex group-hover:scale-110 transition-transform duration-300 shadow-gray-100 text-[#4A7043] bg-white w-14 h-14 border-gray-100 border rounded-2xl mb-6 shadow-lg items-center justify-center">
                <Icon
      ...
      <section id="marketplace" className="py-24 border-y bg-gray-50/30 border-gray-200">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            <div className="group cursor-pointer p-4 rounded-2xl border hover:border-[#4A7043]/30 hover:shadow-xl transition-all duration-300 bg-white border-gray-100 hover:shadow-gray-200/50">
              <div className="rounded-xl h-60 w-full mb-5 relative overflow-hidden group-hover:bg-[#F0F4F1] transition-colors bg-gray-50">
                <div className="absolute inset-0 flex items-center justify-center group-hover:scale-105 transition-transform duration-700 text-gray-300">
              ...
              <h3 className="font-bold text-lg mb-1 group-hover:text-[#4A7043] transition-colors text-gray-900">
                Artisan Teak Console
              </h3>
              <div className="font-bold mb-3 text-gray-900">$125.00</div>
            </div>
            ...
            <div className="group cursor-pointer p-4 rounded-2xl border hover:border-[#4A7043]/30 hover:shadow-xl transition-all duration-300 bg-white border-gray-100 hover:shadow-gray-200/50">
              ...
              <div className="font-bold mb-3 text-gray-900">$45.00</div>
            </div>
            ...
            <div className="group cursor-pointer p-4 rounded-2xl border hover:border-[#4A7043]/30 hover:shadow-xl transition-all duration-300 bg-white border-gray-100 hover:shadow-gray-200/50">
              ...
              <div className="font-bold mb-3 text-gray-900">$24.00</div>
            </div>
            ...
            <div className="group cursor-pointer p-4 rounded-2xl border hover:border-[#4A7043]/30 hover:shadow-xl transition-all duration-300 bg-white border-gray-100 hover:shadow-gray-200/50">
              ...
              <div className="font-bold mb-3 text-gray-900">$18.50</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="relative grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold mb-2 text-gray-900">1. Create Account</h3>
            ...
            <div className="relative flex flex-col items-center text-center">
              <div className="w-16 h-16 rounded-2xl border border-[#4A7043]/20 shadow-lg shadow-[#4A7043]/5 flex items-center justify-center text-[#4A7043] mb-6 bg-white">
                <Icon icon="solar:shop-2-linear" width={32} />
              </div>
              <h3 className="font-semibold mb-2 text-gray-900">2. Set Up Your Store</h3>
              <p className="text-sm px-4 text-gray-600">
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold mb-2 text-gray-900">3. Add Products</h3>
              <p className="text-sm px-4 text-gray-600">
            ...
            <div className="relative flex flex-col items-center text-center">
              ...
              <h3 className="font-semibold mb-2 text-gray-900">4. Start Selling</h3>
              <p className="text-sm px-4 text-gray-600">
      ...
      <footer className="border-t pt-16 pb-8 bg-white border-gray-200">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            <div>
              <div className="flex items-center gap-2 text-[#4A7043] mb-6">
            ...
            <div>
              <h4 className="font-semibold mb-6 text-gray-900">Contact Us</h4>
              <ul className="space-y-4 text-sm text-gray-500">
